...
<asp:Content ID="cont2" ContentPlaceHolderID="phF" Runat="Server">
    <px:PXFormView ID="form" runat="server" DataSourceID="ds" DataMember="MasterView" Width="100%" AllowAutoHide="false">
        <Template>
            ...
            <px:PXMaskEdit runat="server" ID="CstPXMaskEdit1" DataField="Id"/>
            <px:PXTextEdit runat="server" ID="CstPXTextEdit2" DataField="Name"/>
        </Template> <AutoSize Container="Window" Enabled="True" MinHeight="200"></AutoSize>
    </px:PXFormView>
</asp:Content>